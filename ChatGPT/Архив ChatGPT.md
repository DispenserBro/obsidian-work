...
[[Промпты]] - тут сборник промптов для разных целей
...
>[!info]- Промпт для начала работы ИИ с проектом
>```text
>Посмотри код проекта, структурируй его у себя. Не создавай markdown-файлы без моего запроса. Внимательно прочитай все существующие markdown-файлы. Задай вопросы по приложению
>```
